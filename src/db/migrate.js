...
router.post('/fix', async (req, res) => {
  ...
  try {
    ...
    await client.query(`ALTER TABLE users ADD COLUMN IF NOT EXISTS identity_provider TEXT DEFAULT 'manual'`);
    await client.query(`ALTER TABLE users ADD COLUMN IF NOT EXISTS identity_is_verified BOOLEAN DEFAULT false`);
    ...
    await client.query(`ALTER TABLE users ADD COLUMN IF NOT EXISTS persona_inquiry_id TEXT`);
    await client.query(`ALTER TABLE users ADD COLUMN IF NOT EXISTS persona_account_id TEXT`);
    await client.query(`ALTER TABLE users ADD COLUMN IF NOT EXISTS persona_reference_id TEXT`);
    ...
    await client.query(`ALTER TABLE drivers ADD COLUMN IF NOT EXISTS identity_provider TEXT DEFAULT 'manual'`);
    await client.query(`ALTER TABLE drivers ADD COLUMN IF NOT EXISTS identity_is_verified BOOLEAN DEFAULT false`);
    ...
    await client.query(`ALTER TABLE drivers ADD COLUMN IF NOT EXISTS persona_inquiry_id TEXT`);
    await client.query(`ALTER TABLE drivers ADD COLUMN IF NOT EXISTS persona_account_id TEXT`);
    await client.query(`ALTER TABLE drivers ADD COLUMN IF NOT EXISTS persona_reference_id TEXT`);
    ...
    await client.query(`ALTER TABLE operators ADD COLUMN IF NOT EXISTS identity_provider TEXT DEFAULT 'manual'`);
    await client.query(`ALTER TABLE operators ADD COLUMN IF NOT EXISTS identity_is_verified BOOLEAN DEFAULT false`);
    ...
    await client.query(`ALTER TABLE operators ADD COLUMN IF NOT EXISTS persona_inquiry_id TEXT`);
    await client.query(`ALTER TABLE operators ADD COLUMN IF NOT EXISTS persona_account_id TEXT`);
    await client.query(`ALTER TABLE operators ADD COLUMN IF NOT EXISTS persona_reference_id TEXT`);
